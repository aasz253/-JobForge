  ...
  theme: {
    extend: {
      colors: {
        ...
        violet: { DEFAULT: "#8B5CF6", soft: "#6D3FE8" },
        blush: { DEFAULT: "#FF5C93", soft: "#F23B6E" },
        ember: { DEFAULT: "#F85149" },
        emerald: "#3FB950",
        success: { DEFAULT: "#3FB950", soft: "#2EA043" },
        content: { DEFAULT: "#2F81F7", soft: "#1F6FEB" }
      },
      backgroundImage: {
        brand: "linear-gradient(120deg, #2F81F7 0%, #8B5CF6 55%, #FF5C93 100%)"
      },
      fontFamily: {
      ...
      boxShadow: {
        ...
        glow: "0 10px 30px -10px rgba(139,92,246,0.55)"
      }
    }
  },
  plugins: []
